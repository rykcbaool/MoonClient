...
import dev.ryk.api.interfaces.IChatHudHook;
import dev.ryk.api.utils.Wrapper;
import dev.ryk.mod.commands.Command;
import dev.ryk.mod.commands.impl.*;
...
public class CommandManager implements Wrapper {
    ...
    public void command(String[] commandIn) {
        ...
        Command command = commands.get(commandIn[0].substring(MoonClient.PREFIX.length()).toLowerCase());
