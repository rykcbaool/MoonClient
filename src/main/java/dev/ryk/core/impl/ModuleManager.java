...
import dev.ryk.mod.Mod;
import dev.ryk.mod.gui.clickgui.ClickGuiScreen;
import dev.ryk.mod.modules.Module;
import dev.ryk.mod.modules.impl.client.*;
import dev.ryk.mod.modules.impl.combat.*;
import dev.ryk.mod.modules.impl.exploit.*;
import dev.ryk.mod.modules.impl.misc.*;
import dev.ryk.mod.modules.impl.movement.*;
import dev.ryk.mod.modules.impl.player.*;
import dev.ryk.mod.modules.impl.player.freelook.FreeLook;
import dev.ryk.mod.modules.impl.render.*;
import dev.ryk.mod.modules.settings.Setting;
import dev.ryk.mod.modules.settings.impl.BindSetting;
...
public class ModuleManager implements Wrapper {
    ...
    public void render3D(MatrixStack matrixStack) {
        ...
        MoonClient.EVENT_BUS.post(new Render3DEvent(matrixStack, mc.getTickDelta()));
        matrixStack.pop();
