...
import dev.ryk.mod.modules.impl.client.ModuleList;
...
public class ConfigManager extends Manager {
	...
	public static void resetModule() {
		for (Module module : MoonClient.MODULE.modules) {
	...
	public void loadSettings() {
		for (Module module : MoonClient.MODULE.modules) {
			...
			module.setState(MoonClient.CONFIG.getBoolean(module.getName() + "_state", module instanceof HUD || module instanceof ModuleList));
		}
	}
	public void saveSettings() {
		...
		try {
			...
			printwriter.println("prefix:" + MoonClient.PREFIX);
			...
			printwriter.println("armor_x:" + MoonClient.GUI.armorHud.getX());
			printwriter.println("armor_y:" + MoonClient.GUI.armorHud.getY());
			...
			System.out.println("[" + MoonClient.NAME + "] Failed to save settings");
		} finally {
	...
	public void readSettings() {
		...
		try {
			...
			System.out.println("[" + MoonClient.NAME + "] Failed to load settings");
		}
	}
