...
import dev.ryk.mod.modules.impl.client.Colors;
...
public class ColorSetting extends Setting {
	...
	public void loadSetting() {
		this.value = new Color(MoonClient.CONFIG.getInt(this.getLine(), defaultValue.getRGB()), true);
		this.isRainbow = MoonClient.CONFIG.getBoolean(this.getLine() + "Rainbow");
		if (injectBoolean) {
			this.booleanValue = MoonClient.CONFIG.getBoolean(this.getLine() + "Boolean", defaultBooleanValue);
		}
	}
}
