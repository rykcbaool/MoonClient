...
import dev.ryk.asm.accessors.IEntityVelocityUpdateS2CPacket;
import dev.ryk.asm.accessors.IExplosionS2CPacket;
...
public class Velocity extends Module {
	...
	public void onVelocity(EntityVelocityUpdateEvent event) {
		...
		if (mode.is(Mode.Grim) || mode.is(Mode.Wall)) {
			...
			boolean insideBlock = MoonClient.PLAYER.insideBlock;
	...
	public void onUpdate() {
		...
		if (flag) {
			if (lagBackTimer.passed(100) && (flagInWall.getValue() || !MoonClient.PLAYER.insideBlock)) {
