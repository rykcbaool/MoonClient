...
import dev.ryk.asm.accessors.ILivingEntity;
...
import dev.ryk.mod.modules.impl.combat.KillAura;
import dev.ryk.mod.modules.impl.player.PacketEat;
...
public class AutoDupe extends Module {
            ...
            case Xin -> {
                ...
                switch (stage) {
                    ...
                    case Summon -> {
                        ...
                        InventoryUtil.inventorySwap(slot, mc.player.getInventory().selectedSlot);
                        MoonClient.ROTATION.snapAt(MoonClient.ROTATION.lastYaw, 89);
                    ...
                    case Tame -> {
                        ...
                        if (mc.player.hasVehicle()) {
                            ...
                            if (llama.isBaby()) {
                                ...
                                InventoryUtil.inventorySwap(slot, mc.player.getInventory().selectedSlot);
                                MoonClient.ROTATION.lookAt(llama.getPos());
                    ...
                    case Kill -> {
                        ...
                        if (check()) {
                            MoonClient.ROTATION.lookAt(llama.getEyePos());
    ...
    private void closeTo(BlockPos pos) {
        ...
        float forward = 1f;
        float side = 0;
        float yaw = MoonClient.ROTATION.getRotation(pos.toCenterPos())[0];
