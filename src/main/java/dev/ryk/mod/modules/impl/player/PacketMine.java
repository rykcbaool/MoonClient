...
import dev.ryk.api.events.impl.ClickBlockEvent;
...
import dev.ryk.asm.accessors.IPlayerMoveC2SPacket;
...
import dev.ryk.mod.modules.impl.combat.AutoAnchor;
import dev.ryk.mod.modules.impl.combat.AutoCev;
import dev.ryk.mod.modules.impl.combat.AutoCrystal;
import dev.ryk.mod.modules.settings.SwingSide;
import dev.ryk.mod.modules.settings.impl.*;
...
public class PacketMine extends Module {
	...
	public float getDigSpeed(BlockState state, ItemStack itemStack) {
		...
		boolean inWeb = MoonClient.PLAYER.isInWeb(mc.player) && mc.world.getBlockState(breakPos).getBlock() == Blocks.COBWEB;
