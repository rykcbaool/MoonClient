...
public class ClientSetting extends Module {
    ...
    public final StringSetting windowTitle = add(new StringSetting("WindowTitle", MoonClient.NAME, () -> page.is(Page.Misc)));
    ...
    public final StringSetting hackName = add(new StringSetting("Notification", "[MoonClient]", () -> page.getValue() == Page.Notification));
